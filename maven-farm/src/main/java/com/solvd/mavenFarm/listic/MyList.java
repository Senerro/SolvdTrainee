...
public class MyList<T> {
    ...
    public boolean add(int index, T object)
    {
            ...
            if(indexInList(index))
            {
                ...
                var indexedNode = findNodeByIndex(index).previous;
    ...
    public boolean set(int index, T object)
    {
        ...
        if(indexInList(index))
        {
            ...
            var indexedNode = findNodeByIndex(index);
    ...
    public void remove(T object)
    {
       ...
       var prev = findableNode.previous;
       var next = findableNode.next;
       prev.next = next;
       next.previous = prev;
